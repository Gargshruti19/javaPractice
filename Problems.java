...
public class Problems {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
      "Subtraction of product and sum of Digits of an integer : " +
      bothSubstraction
    );
    ...
    System.out.println("Factorial of " + w + " is : " + factorial);
    ...
    //8. Armstrong Number
    System.out.println(
      "Enter any number to check if it is ARMSTRONG NUMBER or not : "
    );
    int c = sc.nextInt();
    int originalC = c;
    int res = 0;
